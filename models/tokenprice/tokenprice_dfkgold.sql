...
historical_prices as (
    ...
    where {{ incremental_load_filter_withdays("timestamp", -5) }}
    and token_address = '0x3a4edcf3312f44ef027acfd8c21382a5259936e7' -- gold
    group by 1
    order by 1 desc
),
...
raw_logs as (
    ...
    from {{ ref('logs') }}
    where {{ incremental_load_filter_withdays("block_timestamp", -5) }}
    and topics[0] = '0xd78ad95fa46c994b6551d0da85fc275fe613ce37657fb8d5e3d130840159d822' -- Swap
